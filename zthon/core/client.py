                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @mvhmed\
                                  \n\n--------بـدء تتبـع سجـل چــٱڪــﯡ 𝙅𝘼𝙆𝙊𝙊--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع چــٱڪــﯡ 𝙅𝘼𝙆𝙊𝙊--------"
                        ...
                        link = "[𝙈𝙊𝙃𝘼𝙈𝙈𝘼𝘿(https://t.me/mvhmed)"
                        text = (
                            "**✘ تقـريـر إشعـار چــٱڪــﯡ 𝙅𝘼𝙆𝙊𝙊 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار چــٱڪــﯡ 𝙅𝘼𝙆𝙊𝙊 ✘**\n\n "
                        link = "[𝙈𝙊𝙃𝘼𝙈𝙈𝘼𝘿(https://t.me/Mvhmed)"
