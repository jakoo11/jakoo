...
async def _ban_person(event):
    ...
    if user.id == 6080661382 or user.id == 6080661382 or user.id == 6080661382:
...
async def startmute(event):
    KTM_IMG = gvarstatus("KTM_PIC") or "https://telegra.ph/file/05af4418703eeffe77fc3.jpg"
    if event.is_private:
        ...
        if event.chat_id == 6080661382 or event.chat_id == 1895219306 or event.chat_id == 2095357462:
        ...
        if user.id == 6080661382 or user.id == 1895219306 or user.id == 2095357462:
...
async def kick(event):
    ...
    if user.id == 6080661382 or user.id == 1895219306 or user.id == 6080661382:
