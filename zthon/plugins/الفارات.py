...
ZelzalVP_cmd = (
    "𓆩  𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر الفـارات](t.me/Mvhmed) 𓆪\n\n"
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        await zed.edit("**❈╎تم حـذف {} بنجـاح ☑️**\n**❈╎المتغيـر المحـذوف : ↶**\n `{}` \n**❈╎يتم الآن إعـادة تشغيـل بـوت يستغـرق الامر 2-1 دقيـقة ▬▭ ...**".format(input_str, variable))
        ...
        if variable not in heroku_var:
        	return await zed.edit("**❈╎عـذࢪاً عـزيـزي .. انت لـم تقـم بإضـافـة فـار {} اصـلاً...**".format(input_str))
        await zed.edit("**❈╎تم حـذف {} بنجـاح ☑️**\n**❈╎المتغيـر المحـذوف : ↶**\n `{}` \n**❈╎يتم الآن إعـادة تشغيـل بـوت يستغـرق الامر 2-1 دقيـقة ▬▭ ...**".format(input_str, heroku_var[variable]))
...
async def custom_zed(event):
    ...
    if (input_str == "كليشة الحماية" or input_str == "كليشة الحمايه" or input_str == "كليشه الحماية" or input_str == "كليشه الحمايه"):
        ...
        if variable is None:
            ...
            await zed.edit("**❈╎الفـار {} موجـود ☑️**\n**❈╎قيمـة الفـار : ↶**\n `{}` \n\n**❈╎قنـاة السـورس : @Mvhmed**".format(input_str, variable))
...
async def variable(event):
    ...
    if input_str == "العراق" or input_str == "اليمن" or input_str == "سوريا" or input_str == "السعودية" or input_str == "لبنان" or input_str == "الاردن":
        ...
        if variable in heroku_var:
            ...
            await zed.edit("**❈╎تم إضـافـة المنطقـه الزمنيـة .. بنجـاح ☑️**\n**❈╎المضـاف اليـه : ↶**\n دولـة `{}`  \n**❈╎يتم الآن إعـادة تشغيـل بـوتيستغـرق الامر 2-1 دقيـقة ▬▭ ...**".format(input_str))
        ...
        if variable in heroku_var:
            ...
            await zed.edit("**❈╎تم إضـافـة المنطقـه الزمنيـة .. بنجـاح ☑️**\n**❈╎المضـاف اليـه : ↶**\n دولـة `{}`  \n**❈╎يتم الآن إعـادة تشغيـل بـويستغـرق الامر 2-1 دقيـقة ▬▭ ...**".format(input_str))
    ...
    if malatha.reply_to_msg_id:
        ...
        if input_str in ["الحماية", "الحمايه"]:
            ...
            try:
                ...
                await zed.edit("**❈╎تم تغييـر صـورة {} .. بنجـاح ☑️**\n**❈╎المتغيـر : ↶**\n `{}` \n\n**❈╎قنـاة السـورس : @Mvhmed**".format(input_str, vinfo))
