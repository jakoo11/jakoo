    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                "https://telegra.ph/file/69007d66c8873aa92a047.jpg",
                
                caption="**•⎆┊تـم بـدء تشغـيل سـورس جاكو الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("𝙎𝙊𝙐𝙍𝘾𝙀 𝙅𝘼𝙆𝙊𝙊", "https://t.me/Mvhmed"),)],
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", "JAKOO")
            ...
            await bot.send_message("@BotFather", f"- بـوت جاكو المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            ...
            "جروب السجـل جاكو", zedub, Config.TG_BOT_USERNAME, descript, photozed
